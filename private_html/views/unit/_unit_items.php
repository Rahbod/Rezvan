...
<?php if (isset($sold) && $sold): ?>
    ...
    <div class="item item-3">
        ...
        <span class="item-2"><?= $model->getBedRoomStr() ?></span>
    </div>
    <div class="item item-4">
        <img src="<?= $baseUrl . '/images/item-4-l.png' ?>" alt="item-4">
        <span class="item-2"><?= $model->getAirConditionerStr() ?></span>
    </div>
    <div class="item item-5">
        <img src="<?= $baseUrl . '/images/item-5-l.png' ?>" alt="item-5">
        <span class="item-2"><?= $model->getWcStr() ?></span>
    </div>
    <div class="item item-6">
        <img src="<?= $baseUrl . '/images/item-6-l.png' ?>" alt="item-6">
        <span class="item-2"><?= $model->getBathRoomStr() ?></span>
    </div>
    <div class="item item-7">
        <img src="<?= $baseUrl . '/images/item-7-l.png' ?>" alt="item-7">
        <span class="item-2"><?= $model->getParkingStr() ?></span>
    </div>
    <div class="item item-8">
        <img src="<?= $baseUrl . '/images/item-8-l.png' ?>" alt="item-8">
        <span class="item-2"><?= $model->getRadiatorStr() ?></span>
    </div>
